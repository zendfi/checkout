                      ...
                      {showAddressFields && (
                        <div className="space-y-2.5">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            <input type="text" value={city} onChange={(e) => setCity(e.target.value)} placeholder="City" autoComplete="address-level2" disabled={isLoading || isVerifying} className="w-full px-3 py-3 text-base border border-gray-200 rounded-xl focus:outline-none focus:border-gray-900 transition-colors bg-white" />
                            <input type="text" value={stateField} onChange={(e) => setStateField(e.target.value)} placeholder="State" autoComplete="address-level1" disabled={isLoading || isVerifying} className="w-full px-3 py-3 text-base border border-gray-200 rounded-xl focus:outline-none focus:border-gray-900 transition-colors bg-white" />
                          </div>
                          <div className="grid grid-cols-2 gap-2">
                            <input type="text" value={postalCode} onChange={(e) => setPostalCode(e.target.value)} placeholder="Postal code" autoComplete="postal-code" disabled={isLoading || isVerifying} className="w-full px-3 py-3 text-base border border-gray-200 rounded-xl focus:outline-none focus:border-gray-900 transition-colors bg-white" />
                            <input type="text" value={country} onChange={(e) => setCountry(e.target.value)} placeholder="Country (e.g. NG)" autoComplete="country" maxLength={2} disabled={isLoading || isVerifying} className="w-full px-3 py-3 text-base border border-gray-200 rounded-xl focus:outline-none focus:border-gray-900 transition-colors bg-white" />
                          </div>
                        </div>
                      )}
                    </>
